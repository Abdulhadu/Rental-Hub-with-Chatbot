              ...
              <div className="flex-1">
                <div className="item-body dashboard-wrapper w-full">
                  <div className="welcome-msg w-full">
                    <div>
                      <p className="text-black text-lg">Hello, Shovo</p>
                  ...
                  <div className="quick-view-grid w-full flex justify-between items-center mt-3 ">
                    <div className="v-item w-[252px] h-[208px] bg-black group hover:bg-yellow transition-all duration-300 ease-in-out p-6">
                      ...
                      <p className="text-xl text-white group-hover:text-blacktext mt-5">
                        New Orders
                      </p>
                      <span className="text-[40px] text-white group-hover:text-blacktext font-bold leading-none mt-1 block">
                        656
                      </span>
                    </div>
                    <div className="v-item w-[252px] h-[208px] bg-black group hover:bg-yellow transition-all duration-300 ease-in-out p-6">
                      ...
                      <div className="mt-5">
                        <table>
                          <tr className="inline-flex mb-5">
                            <td className="text-base text-graytwo w-[100px] block">
                              <div>Name:</div>
                            </td>
                            <td className="text-base text-black font-medium">
                              Shuvo khan
                            </td>
                          </tr>
                          <tr className="inline-flex mb-5">
